...
trait Test99Attribute
{
    ...
    /**
     * @return string  test99
     */
    public function getEditButtonAttribute()
    {
        return '<a href="' .
            route('admin.test99.edit', $this) .
            '" data-toggle="tooltip" data-placement="top" title="' .
    ...
    {
        return '<a href="' .
            route('admin.test99.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<div
       class="btn-group btn-group-sm" test99="group" aria-label="Test99 Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
