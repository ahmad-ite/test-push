...
trait Test100Attribute
{
    ...
    /**
     * @return string  test100
     */
    public function getEditButtonAttribute()
    {
        return '<a href="' .
            route('admin.test100.edit', $this) .
            '" data-toggle="tooltip" data-placement="top" title="' .
    ...
    {
        return '<a href="' .
            route('admin.test100.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<div
       class="btn-group btn-group-sm" test100="group" aria-label="Test100 Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
